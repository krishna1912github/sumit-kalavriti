      ...
      <div className="md:flex md:flex-row gap-8 flex flex-col bg-green mx-auto justify-center items-center w-[80%] ">
        <div className="flex flex-row gap-2 w-[40%] mx-auto justify-center">
          <div className="flex flex-col gap-3 w-[15%]">
            <div className="overflow-hidden object-cover object-center h-25  md:w-32 md:h-32 lg:w-20 lg:h-20 rounded-lg">
              <Image
          ...
          <div className="w-[75%]">
            <div>
              <h1 className="text-2xl font-bold text-gray-800  text-justify px-1">
                ...
                Hours Playback, 40MM Drivers, Padded Ear Cushions,{' '}
              </h1>
              <div className="mt-4">
                <p className="text-gray-600 mt-4">
                  Toy combat drones, redesigned with color options that reflect
                  the natural environment, perfect for a long-lasting battery
                  life and high-definition photography. Experience advanced
                  technology in drone racing and artwork capturing.
                </p>
              </div>
            </div>
            ...
            <div className="flex- flex-row gap-4 justify-items-start mt-6">
              ...
              <button
                type="button"
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-none text-sm py-2.5 px-5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                Buy now
              </button>
            </div>
        ...
        <div id="default-tab-content">
          ...
          >
            <p className=" w-[80%] text-base text-gray-500 dark:text-gray-400 ml-10  flex flex-wrap justify-start">
              ...
              content visibility and styling. . PROFILEE another tab will toggle
              the visibility of this one for the next. The tab JavaScript swaps
              classes to control the content visibility and styling. . Clicking
          ...
          >
            <p className=" w-[80%] text-base text-gray-500 dark:text-gray-400 ml-10  flex flex-wrap justify-start">
              . dashboard dashboard dashboard dashboard toggle the visibility of
              this one for the next. The tab JavaScript swaps classes to control
              the content visibility and styling. . Clicking another tab will
          ...
          >
            <p className=" w-[80%] text-base text-gray-500 dark:text-gray-400 ml-10  flex flex-wrap justify-start">
              ...
              content visibility and styling. . Clicking another tab will toggle
              the visibility of this one for the next. The tab JavaScript swaps
              classes to control the content visibility and styling. . Clicking
              another tab will toggle the visibility of this one for the next.
              The tab JavaScript swaps classes to control the content visibility
