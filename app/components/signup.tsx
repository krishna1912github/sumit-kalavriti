...
export default function sigup() {
  return (
    <div className="relative w-screen h-screen flex items-center justify-center">
      <div className="relative w-1/2 h-full flex justify-center items-center  bg-orange-500 drop-shadow-2xl">
        <div className="absolute w-60 h-35 top-20 left-10 ">
          <p>1</p>
          <Image
            ...
            className="rounded-xl w-[90%] h-55"
          />
        </div>
        <div className="absolute w-60 h-35 top-40 left-50 rounded-lg">
          <p>2</p>
          <Image
            src="https://cdn.shopify.com/s/files/1/0551/4566/0472/files/Chalet_Collection_Feature_2.jpg?v=1654902306"
            alt="Decorative Showpiece"
        ...
        <div className="absolute w-60 h-35 top-30 left-5 rounded-lg">
          <p>3</p>
          <Image
            src="https://cdn.shopify.com/s/files/1/0551/4566/0472/files/Chalet_Collection_Feature_2.jpg?v=1654902306"
            alt="Decorative Showpiece"
      ...
      <div className="w-1/2 h-full flex flex-col justify-between py-12 bg-white ">
        ...
        <div className="px-20 text-center ">
          ...
          <p className="text-sm text-gray-600 mb-10">
            Please Fill your Details to Get access to Your Account
          </p>
          ...
          <div className="absolute top-[-50px] bottom-[80px] right-[100px]  flex items-center ps-3.5 pointer-events-none">
            <svg
              width="20"
              height="17"
              viewBox="0 0 16 13"
          ...
          <div className="mb-10">
            ...
            <input
              ...
              className="w-full p-3 border border-gray-300 rounded-lg shadow-sm"
            />
            <div className="absolute top-[55px] bottom-0 right-[100px]  flex items-center ps-3.5 pointer-events-none">
              <svg
                width="20"
                height="18"
                viewBox="0 0 17 15"
