...
import {StateCategoryCard} from './stateCategoryCard';
  ...
  return (
    <Link to={`/collections/`} prefetch="viewport">
      <section className="p-4">
        <p className="text-[40px] font-bold my-6">Shop by State</p>
        <div className="flex align-item-center">
          <div className=" p-4 w-4/12  text-center sm:px-8 md:px-12 from-primary/60 text-contrast">
            <div
              style={{
                background:
                  'linear-gradient(204.79deg, #D9B39D 22.04%, #F5E7DC 90.53%)',
              }}
              className="p-6 "
            >
          ...
          <div className="w-10/12">
            <StateCategoryCard collections={object} />
          </div>
        </div>
      </section>
    </Link>
